...
const Navbar = () => {
  ...
  return (
    <div className="fixed z-[999] w-full flex items-center justify-between px-5 py-4 lg:px-12">
      <div className="logo">
        <svg
          width="72"
          height="30"
        ...
        {['Services', 'Our Work', 'About Us', 'Insights', 'Contact us'].map(
          (item, index) => {
            return (
              <h5
                key={index}
                className="group relative inline-flex h-[24px] overflow-hidden cursor-pointer"
              >
                <a
                  href="#"
                  className={`block text-md font-neue font-light transition-transform duration-300 ease-out group-hover:-translate-y-full ${index === 4 && 'ml-28'}`}
                >
                  {item}
                </a>
                ...
                <a
                  href="#"
                  className={`absolute left-0 top-full block text-md font-neue font-light transition-transform duration-300 ease-out group-hover:-translate-y-full ${index === 4 && 'ml-28'}`}
                >
                  {item}

                  <span
                    className="absolute bottom-0 left-0 h-[1px] w-full border-1 bg-current scale-x-0 origin-left transition-transform duration-500 ease-out group-hover:scale-x-100"
                  />
                </a>
              </h5>
            );
